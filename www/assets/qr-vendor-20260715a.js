...
}; const cache={}; function req(id){ if(cache[id]) return cache[id].exports; if(!modules[id]) throw new Error("QR module not found: "+id); const module={exports:{}}; cache[id]=module; modules[id](module,module.exports,req); return module.exports; } return {QRCode:req("./index"), QRErrorCorrectLevel:req("./QRErrorCorrectLevel")};})();
